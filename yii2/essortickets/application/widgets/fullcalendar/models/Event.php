...
namespace app\widgets\fullcalendar\models;

/**
 * Class Event
 * @package app\widgets\fullcalendar\models
 */
class Event extends \yii\base\Model
{
	...
	public $title;
    /** @var  string The description on an event's element */
    public $description;
    /** @var  string The ticket on an event's element */
    public $ticket;
