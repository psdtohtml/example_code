...
DayGrid.mixin({
	...
	fgSegHtml: function(seg, disableResizing) {
		...
		ticketHtml =
			'<span class="fc-ticket">' +
			(htmlEscape(event.ticket || '') || '&nbsp;') + // we always want one line of height
			'</span>';
		...
		return '<a class="' + classes.join(' ') + '"' +
			...
			'>' +
				'<div class="fc-content">' +
					(this.isRTL ?
						titleHtml + ' | ' + timeHtml + ' | ' + ticketHtml: // put a natural space in between
						timeHtml + ' | ' + titleHtml  + ' | ' + ticketHtml  //
						) +
				'</div>' +
